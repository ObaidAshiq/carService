...
import UserInterface from '../Components/playground/UserInterface';
...
function AppointmentSystem({ parameters, url, code }:any) {
    ...
    async function getAppointments() {
      ...
      try {
        ...
        if(response && !response.error) {
          ...
          setAppointments(temp.sort((a:any, b:any) => { return a.time.getTime() - b.time.getTime(); }));
        }
        else {
